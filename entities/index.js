...
export default restart => {
    ...
    return{
        ...
        ObstacleBottom1: Obstacle(world,'ObstacleBottom1', 'dodgerblue', pipeSizePosA.pipeBottom.pos, pipeSizePosA.pipeBottom.size),

        ObstacleTop2: Obstacle(world,'ObstacleTop2', 'red', pipeSizePosB.pipeTop.pos, pipeSizePosB.pipeTop.size),
        ObstacleBottom2: Obstacle(world,'ObstacleBottom2', 'dodgerblue', pipeSizePosB.pipeBottom.pos, pipeSizePosB.pipeBottom.size),
